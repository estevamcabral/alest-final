...
public class App {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("Busca realizada! foram encontradas " + search.getListSize() + " palavra(s).");
            ...
            System.out.println("Tempo para busca de palavras na lista encadeada: " + search.getTempoDeBuscaLista()
                    + " nanosegundos.");
            ...
            System.out.println(
                    "Tempo para busca de palavras na arvore binaria de pesquisa: " + search.getTempoDeBuscaLista()
                            + " nanosegundos.");
            System.out.println("");
            System.out.println("-------------------------------------------------");
            System.out.println("");
